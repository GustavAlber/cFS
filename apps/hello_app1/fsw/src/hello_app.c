...
void HELLO_APP_Main(void)
{
    ...
    */
    ...
    status = CFE_MSG_Init(CFE_MSG_PTR(HELLO_APP_Data.VotingMessage1.TelemetryHeader), /* Location of SB Message Data Buffer */
                            CFE_SB_ValueToMsgId(0xB1),                     /* SB Message ID associated with Data */
    ...
    status = CFE_MSG_Init(CFE_MSG_PTR(HELLO_APP_Data.VotingMessage2.TelemetryHeader), /* Location of SB Message Data Buffer */
                            CFE_SB_ValueToMsgId(0xB2),                     /* SB Message ID associated with Data */
                            sizeof(HELLO_APP_Data.VotingMessage2));      /* Size of Buffer */
    status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(0xB1), HELLO_APP_Data.Data1Pipe);
    if (status != CFE_SUCCESS)
    {
    ...
    status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(0xB2), HELLO_APP_Data.Data2Pipe);
    if (status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(HELLO_APP_INIT_INF_EID, CFE_EVS_EventType_ERROR,
                            "Hello App: Error Subscribing to HK request, RC = 0x%08lX", (unsigned long)status);
    ...
    */
    status = CFE_MSG_Init(CFE_MSG_PTR(HELLO_APP_Data.ConsentMessage1.TelemetryHeader), /* Location of SB Message Data Buffer */
                            CFE_SB_ValueToMsgId(0xB3),                     /* SB Message ID associated with Data */
    ...
    status = CFE_MSG_Init(CFE_MSG_PTR(HELLO_APP_Data.ConsentMessage2.TelemetryHeader), /* Location of SB Message Data Buffer */
                            CFE_SB_ValueToMsgId(0xB4),                     /* SB Message ID associated with Data */
                            sizeof(HELLO_APP_Data.ConsentMessage2));      /* Size of Buffer */
    status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(0xB3), HELLO_APP_Data.Data1Pipe);
    if (status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(HELLO_APP_INIT_INF_EID, CFE_EVS_EventType_ERROR,
                            "Hello App: Error Subscribing to HK request, RC = 0x%08lX", (unsigned long)status);
    }
    status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(0xB4), HELLO_APP_Data.Data2Pipe);
    if (status != CFE_SUCCESS)
    {
        CFE_EVS_SendEvent(HELLO_APP_INIT_INF_EID, CFE_EVS_EventType_ERROR,
                            "Hello App: Error Subscribing to HK request, RC = 0x%08lX", (unsigned long)status);
    ...
    */
    while (CFE_ES_RunLoop(&HELLO_APP_Data.RunStatus) == true)
    {
        ...
        if ((error1 == false) && (error2 == false))
        {
            ...
            //CFE_EVS_SendEvent(HELLO_APP_INIT_INF_EID, CFE_EVS_EventType_INFORMATION,"hello App 1 Vote1 %f", rec->Temp);
            ...
            //CFE_EVS_SendEvent(HELLO_APP_INIT_INF_EID, CFE_EVS_EventType_INFORMATION,"hello App 1 Vote2 %f", rec->Temp);
            ...
            if((own == app0) && (own == app2))
            {
                CFE_EVS_SendEvent(HELLO_APP_INIT_INF_EID, CFE_EVS_EventType_INFORMATION,"hello App 1 Votind ident");
            ...
            {
                CFE_EVS_SendEvent(HELLO_APP_INIT_INF_EID, CFE_EVS_EventType_INFORMATION,"hello App 1 Votind APP2 down %f", app2);
                HELLO_APP_Data.ConsentMessage1.con[0] = true;
                HELLO_APP_Data.ConsentMessage1.con[1] = true;
            ...
            {
                CFE_EVS_SendEvent(HELLO_APP_INIT_INF_EID, CFE_EVS_EventType_INFORMATION,"hello App 1 Votind APP0 down%f", app0);
            ...
            {
                CFE_EVS_SendEvent(HELLO_APP_INIT_INF_EID, CFE_EVS_EventType_INFORMATION,"hello App 1 Votind fucked");
                HELLO_APP_Data.ConsentMessage1.con[0] = false;
                HELLO_APP_Data.ConsentMessage1.con[1] = false;
                HELLO_APP_Data.ConsentMessage1.con[2] = false;
                HELLO_APP_Data.ConsentMessage2.con[0] = false;
            ...
            if(HELLO_APP_Data.ConsentMessage1.con[1] == false)
            {
                char                               LocalApp[OS_MAX_API_NAME] = "HELLO_APP1";
...
CFE_Status_t HELLO_APP_Init(void)
{
    ...
    */
    ...
    strncpy(HELLO_APP_Data.RecVote1PipeName, "HELLO_APP_01_PIPE", sizeof(HELLO_APP_Data.RecVote1PipeName));
    HELLO_APP_Data.RecVote1PipeName[sizeof(HELLO_APP_Data.RecVote1PipeName) - 1] = 0;

    strncpy(HELLO_APP_Data.RecVote2PipeName, "HELLO_APP_21_PIPE", sizeof(HELLO_APP_Data.RecVote2PipeName));
    ...
    */
    ...
    strncpy(HELLO_APP_Data.Pipe1Name, "HELLO_APP_10_PIPE", sizeof(HELLO_APP_Data.Pipe1Name));
    ...
    */
    ...
    strncpy(HELLO_APP_Data.Pipe2Name, "HELLO_APP_12_PIPE", sizeof(HELLO_APP_Data.Pipe2Name));
